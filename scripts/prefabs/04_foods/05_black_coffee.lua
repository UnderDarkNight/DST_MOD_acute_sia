...
local assets = {
    Asset("ANIM", "anim/acute_sia_food_black_coffee.zip"), 
    Asset( "IMAGE", "images/inventoryimages/acute_sia_food_black_coffee.tex" ),  -- 背包贴图
    Asset( "ATLAS", "images/inventoryimages/acute_sia_food_black_coffee.xml" ),
}
...
local function fn()
    ...
    inst.AnimState:SetBank("acute_sia_food_black_coffee") -- 地上动画
    inst.AnimState:SetBuild("acute_sia_food_black_coffee") -- 材质包，就是anim里的zip包
    ...
    ------ 物品名 和检查文本
        ...
        inst.components.inventoryitem.imagename = "acute_sia_food_black_coffee"
        inst.components.inventoryitem.atlasname = "images/inventoryimages/acute_sia_food_black_coffee.xml"
...
return Prefab("acute_sia_food_black_coffee", fn, assets)